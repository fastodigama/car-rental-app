...
const VideoSection = () => {
  ...
  return (
    <section className='px-4 sm:py-20 py-16 flex justify-center items-center bg-white'>
        <div className='relative w-full max-w-7x head-reveal'>
            {/* Image Container */}
            ...
            <button className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer z-10' onClick={() => setShowVideo(true)}>
                <span className='relative flex justify-center items-center w-20 h-20 rounded-full bg-white opacity-70 shadow-xl'>
            ...
            {showVideo && (
                <div className='fixed inset-0 bg-black bg-opacity-10 z-50 flex justify-center items-center px-4'>
                    <div className='relative w-full max-w-3xl'>
                       ...
                       <div className='aspect-e-16 aspect-h-9 h-[400px] w-full'>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/kDdkvrCxkqk?si=LJgIIIZmGyXHaVDm" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen
