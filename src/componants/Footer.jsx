    ...
    return (
        <footer className='bg-gray-900 text-gray-300 py-16 px-4 sm:px-6 lg:px-20'>
            <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10'>
                ...
                {/* Company Info */}
                <div>
                    <Link to={"/"} className='flex items-center space-x-2'><Car className='w-8 h-8 text-blue-500' /><span className='text-xl font-bold'>AutoRent</span></Link>
                    <p className='leading-relaxed my-4'>
                        Your trusted partener for premium car rentals. Experience the freedom of the road with our quality vehicles and exceptional service.
                    </p>
                ...
                <div>
                    ...
                    <ul className='space-y-3'>
                        <li className='flex items-center gap-2'><Phone className='text-blue-500 w-5 h-5' />+1 (416) 805-1041 </li>
                        <li className='flex items-center gap-2'><Mail className='text-blue-500 w-5 h-5' /> info@autorent.com</li>
                        <li className='flex items-center gap-2'><MapPin className='text-blue-500 w-5 h-5'/>123 Main St. Mississauga, Ontario A1A 1A1</li>
                    </ul>
                </div>
            </div>
