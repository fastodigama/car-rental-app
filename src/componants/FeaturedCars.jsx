...
const FeaturedCars = () => {
  return (
    <section className='bg-gray-100 py-20 sm:px-16 px-4'>
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='flex flex-wrap gap-2 mt-3 '>
                            {car.badges.map((badge, i) => (
                                <span key={i} className='bg-gray-50 text-xs px-3 py-1 rounded-full font-semibold border border-gray-200 '>{badge}</span>
                            )
                         )}
                        </div>
                        <div className='mt-4'>
                        ...
                        <div className='flex sm:flex-row flex-col mt-4 gap-3'>
                            ...
                            <button className='sm:w-1/2 w-full border border-gray-300 bg-green-600  text-white px-3 py-2 rounded cursor-pointer transition duration-300 hover:bg-green-700'>Book Now</button>
        ...
        <button className='mx-auto flex items-center justify-center mt-12 bg-blue-500 py-3 px-5 text-white rounded cursor-pointer gap-1 transition duration-300 hover:bg-blue-700'>View All Cars <ArrowRight className='h-5 w-5' /> </button>
    </section>
  )
}
