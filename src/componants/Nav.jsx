        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='flex justify-between items-center h-16'>
                ...
                <div className='hidden md:flex items-center space-x-4'>
                    <Link to={"/login"} className='py-1 px-2 flex items-center gap-2 rounded-sm transition duration-300 hover:bg-gray-200'><LogIn className='h-4 w-4' /> Login</Link>
            ...
            { isMenuOpen && ( 
                <div className='md:hidden'> 
                    <div className='px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t'>
                        <Link to={'/'} className='block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-700' onClick={() => setIsMenuOpen(false)}>Home</Link>
                        <Link to={'/cars'} className='block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-700' onClick={() => setIsMenuOpen(false)}>Cars</Link>
                        <Link to={'/about'} className='block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-700' onClick={() => setIsMenuOpen(false)}>About</Link>
                        <Link to={'/contact'} className='block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-700' onClick={() => setIsMenuOpen(false)}>Contact</Link>
                    </div>
